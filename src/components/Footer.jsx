...
const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen px-10 py-2">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6.5vw] font-bold tracking-tighter -mb-16 uppercase">
            eye-
          </h1>
          <h1 className="text-[6.5vw] font-bold tracking-tighter -mb-16 uppercase">
            opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-bold tracking-tightest -mb-20 uppercase">
          presentations
        </h1>
        <div className="main w-full h-3/4 mt-20 flex capitalize">
          <div className="left w-full h-full">
            <div className="flex flex-col ">
              <span className="font-['Neue_Montreal'] mb-5">S:</span>
              <span>Instagram</span>
              <span>Behence</span>
              <span>Facebook</span>
              <span>Linkedin</span>
