...
const Navbar = () => {
  return (
    <Headroom>
      <div className="z-[999] w-full px-14 py-4 font-['Neue_Montreal'] flex justify-between items-center selection:bg-black selection:text-white backdrop-blur-sm">
        <div className="logo">
          <svg
            width="72"
            height="30"
          ...
          {["Services", "Our work", "About us", "Insights", "Contact Us"].map(
            (item, index) => (
              <div className="w-auto h-5 relative">
                <a
                  key={index}
                  className={`group text-base relative w-18 block capitalize font-light after:content[""] after:absolute after:h-[1.5px] after:bg-black after:bottom-[-2px] after:left-[0px] after:w-full after:scale-x-0 after:scale-y-50 after:duration-300 after:transition-transform ease-in-out after:origin-right  after:hover:origin-left  after:hover:scale-x-100 ${
                    index === 4 && "ml-72"
                  }`}
                >
                  {item}
